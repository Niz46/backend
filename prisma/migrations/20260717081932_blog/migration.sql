...
CREATE TABLE "BlogPost" (
    ...
    "coverImageUrl" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "coverVideoUrl" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
-- AddForeignKey
ALTER TABLE "PostLike" ADD CONSTRAINT "PostLike_postId_fkey" FOREIGN KEY ("postId") REFERENCES "BlogPost"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
