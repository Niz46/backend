const blogPostIdeasPrompt = (topic) => `
    Generate a list of 5 blog post ideas related to the ${topic}.
    
For each blog post idea, return:
- a title
- a 3-line description about the post
- 5 relevant tags
...
function generateReplyPrompt(comment) {
  ...
  return `Your 're replying to a blog comment by ${authorName}. The comment says:
...
const blogSummaryPrompt = (blogContent) => `
    ...
    Return the result in **vaild JSON** with the following structure:
    ...
    Only return valid JSON. Do not include markdown or code block around the JSON.
